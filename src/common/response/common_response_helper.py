...
async def success_response(status: str = "success",code:int = 200,message: str = "Success",data: Any = None,type:str="api_success"):
    ...
    print(data)
    print("22222")
    return ResponseModel(status="success",status_code=code, message=message, data=data,type="api_success")
